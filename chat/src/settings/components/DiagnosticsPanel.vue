  ...
  <section class="side-panel">
    ...
    <section class="diagnostics-section">
      <div class="diagnostics-section__header">
        ...
        <button class="app-button app-button-secondary" type="button" @click="copyDiagnostics(safeDiagnostics)">
    ...
    <section v-if="detailConfirmed" class="diagnostics-section">
      <div class="diagnostics-section__header">
        <h3>{{ i18n.t('settings.diagnosticsDevelopmentDetails') }}</h3>
        <button class="app-button app-button-secondary" type="button" @click="copyDiagnostics(detailedDiagnostics)">
    ...
    <div v-else class="diagnostics-detail-gate">
      <button
      ...
      <template v-else>
        ...
        <button class="app-button" type="button" @click="confirmDetail">
...
function copyDiagnostics(value: string): void {
